...
/**
 * Bean info for Minimap component.
 * 
 * @author Tomasz Jędrzejewski
 */
public class MinimapBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( org.invenzzia.opentrans.client.ui.commons.Minimap.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_cursorPosition = 20;
    private static final int PROPERTY_cursorSet = 21;
    private static final int PROPERTY_data = 22;
    ...
    private static final int PROPERTY_emptySegmentColor = 27;
    ...
    private static final int PROPERTY_highlightEmptySegmentColor = 49;
    private static final int PROPERTY_highlightUsedSegmentColor = 50;
    ...
    private static final int PROPERTY_maximumSegmentSize = 66;
    ...
    private static final int PROPERTY_usedSegmentColor = 97;
    ...
    private static final int PROPERTY_viewport = 102;
    private static final int PROPERTY_viewportEmptySegmentColor = 103;
    private static final int PROPERTY_viewportUsedSegmentColor = 104;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", org.invenzzia.opentrans.client.ui.commons.Minimap.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorPosition] = new IndexedPropertyDescriptor ( "cursorPosition", org.invenzzia.opentrans.client.ui.commons.Minimap.class, null, null, null, "setCursorPosition" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_data] = new PropertyDescriptor ( "data", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getData", "setData" ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_emptySegmentColor] = new PropertyDescriptor ( "emptySegmentColor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getEmptySegmentColor", "setEmptySegmentColor" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", org.invenzzia.opentrans.client.ui.commons.Minimap.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_highlightEmptySegmentColor] = new PropertyDescriptor ( "highlightEmptySegmentColor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getHighlightEmptySegmentColor", "setHighlightEmptySegmentColor" ); // NOI18N
            properties[PROPERTY_highlightUsedSegmentColor] = new PropertyDescriptor ( "highlightUsedSegmentColor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getHighlightUsedSegmentColor", "setHighlightUsedSegmentColor" ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSegmentSize] = new PropertyDescriptor ( "maximumSegmentSize", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getMaximumSegmentSize", "setMaximumSegmentSize" ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_usedSegmentColor] = new PropertyDescriptor ( "usedSegmentColor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getUsedSegmentColor", "setUsedSegmentColor" ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_viewport] = new PropertyDescriptor ( "viewport", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getViewport", "setViewport" ); // NOI18N
            properties[PROPERTY_viewportEmptySegmentColor] = new PropertyDescriptor ( "viewportEmptySegmentColor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getViewportEmptySegmentColor", "setViewportEmptySegmentColor" ); // NOI18N
            properties[PROPERTY_viewportUsedSegmentColor] = new PropertyDescriptor ( "viewportUsedSegmentColor", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getViewportUsedSegmentColor", "setViewportUsedSegmentColor" ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", org.invenzzia.opentrans.client.ui.commons.Minimap.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( org.invenzzia.opentrans.client.ui.commons.Minimap.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_interpolate68 = 68;
    ...
    private static final int METHOD_paintComponent95 = 95;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_interpolate68] = new MethodDescriptor(org.invenzzia.opentrans.client.ui.commons.Minimap.class.getMethod("interpolate", new Class[] {int.class, int.class, int.class})); // NOI18N
            methods[METHOD_interpolate68].setDisplayName ( "" );
            ...
            methods[METHOD_paintComponent95] = new MethodDescriptor(org.invenzzia.opentrans.client.ui.commons.Minimap.class.getMethod("paintComponent", new Class[] {java.awt.Graphics.class})); // NOI18N
            methods[METHOD_paintComponent95].setDisplayName ( "" );
...
//GEN-LAST:Superclass
	 ...
	 * information should be obtained by automatic analysis. <p> If a property is indexed, then its entry in the result array will
	 * belong to the IndexedPropertyDescriptor subclass of PropertyDescriptor. A client of getPropertyDescriptors can use "instanceof"
	 * to check if a given PropertyDescriptor is an IndexedPropertyDescriptor.
	 */
	 ...
	 *
	 * @return An array of EventSetDescriptors describing the kinds of events fired by this bean. May return null if the information
	 ...
	 *
	 * @return An array of MethodDescriptors describing the methods implemented by this bean. May return null if the information should
	...
	/**
	 * A bean may have a "default" property that is the property that will mostly commonly be initially chosen for update by human's who
	 * are customizing the bean.
	 *
	 * @return Index of default property in the PropertyDescriptor array returned by getPropertyDescriptors. <P>	Returns -1 if there is
	 * no default property.
	 */
	 ...
	 *
	 * @return Index of default event in the EventSetDescriptor array returned by getEventSetDescriptors. <P>	Returns -1 if there is no
	 * default event.
	 */
	 ...
	 * typically be GIFs, but may in future include other formats. <p> Beans aren't required to provide icons and may return null from
	 * this method. <p> There are four possible flavors of icons (16x16 color, 32x32 color, 16x16 mono, 32x32 mono). If a bean choses to
	 * only support a single icon we recommend supporting 16x16 color. <p> We recommend that icons have a "transparent" background so
