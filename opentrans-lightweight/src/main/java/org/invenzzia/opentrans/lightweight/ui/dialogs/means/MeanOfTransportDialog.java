...
public class MeanOfTransportDialog extends javax.swing.JDialog {
	...
	/**
	 * Changes the enabled state of 'overtaking punishment' field.
	 * 
	 * @param value New state
	 */
	public void setOvertakingSpeedPunishmentEnabled(boolean value) {
		this.overtakingSpeedPunishmentField.setEnabled(value);
	}
	
	/**
	 * Sets the value of the read-only 'has vehicle types' field.
	 * 
