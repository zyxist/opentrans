 ...
 */
@CommandDetails(name = "Add stop")
public class AddStopCmd extends AtomicAddCmd<Stop, StopRecord, StopManager> {
	public AddStopCmd(StopRecord record) {
		super(record);
	}
