...
import org.invenzzia.opentrans.visitons.editing.common.AtomicAddCmd;

/**
 * Represents an action of adding a single vehicle.
 * 
 * @author Tomasz Jędrzejewski
 */
@CommandDetails(name = "Add vehicle")
public class AddVehicleCmd extends AtomicAddCmd<Vehicle, VehicleRecord, VehicleManager> {
	public AddVehicleCmd(VehicleRecord record) {
		super(record);
	}
	...
	@Override
	protected Vehicle createNewItem() {
		return new Vehicle();
	}
