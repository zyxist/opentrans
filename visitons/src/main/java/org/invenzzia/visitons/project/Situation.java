...
/**
 * A situation is a collection of lines, vehicles and other customizable
 * objects. More than one situation can be created for a given work, allowing
 * the analysis of different cases/variants etc.
 * 
 * @author Tomasz Jędrzejewski
 */
public class Situation implements IPersistable<String>
{
	@Override
